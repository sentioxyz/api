...
import type { ai_service, alert_service, rul_service, analytic_service, {owner_service, web_service, insights_service, metrics_service, google, move_service, price_service, processor_service, solidity_service } from './types.gen';
...
export class AlertsService {
     ...
     */
    public static deleteAlertRule<ThrowOnError extends boolean = false>(options: Options<rul_service.DeleteAlertRuleData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<rul_service.DeleteAlertRuleResponse, unknown, ThrowOnError>({
            security: [
                {
                    name: 'api-key',
                    type: 'apiKey'
...
export class DataService {
     ...
     */
    public static cancelSqlQuery<ThrowOnError extends boolean = false>(options: Options<{owner_service.CancelSqlQueryData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<{owner_service.CancelSqlQueryResponse, unknown, ThrowOnError>({
            security: [
                {
                    name: 'api-key',
                    type: 'apiKey'
     ...
     */
    public static deleteRefreshableMaterializedView<ThrowOnError extends boolean = false>(options: Options<{owner_service.DeleteRefreshableMaterializedViewData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<{owner_service.DeleteRefreshableMaterializedViewResponse, unknown, ThrowOnError>({
            security: [
                {
                    name: 'api-key',
                    type: 'apiKey'
...
export class ProcessorService {
     ...
     */
    public static activatePendingVersion<ThrowOnError extends boolean = false>(options: Options<{owner_service.ActivatePendingVersionData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<{owner_service.ActivatePendingVersionResponse, unknown, ThrowOnError>({
            security: [
                {
                    name: 'api-key',
                    type: 'apiKey'
...
export class ForksService {
     ...
     * Delete fork by id
     */
    public static deleteFork<ThrowOnError extends boolean = false>(options: Options<{owner_service.DeleteForkData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<{owner_service.DeleteForkResponse, unknown, ThrowOnError>({
            security: [
                {
                    name: 'api-key',
                    type: 'apiKey'
