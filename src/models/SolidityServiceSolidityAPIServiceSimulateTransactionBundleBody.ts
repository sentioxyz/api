...
export class SolidityServiceSolidityAPIServiceSimulateTransactionBundleBody {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return SolidityServiceSolidityAPIServiceSimulateTransactionBundleBody.attributeTypeMap;
    }
