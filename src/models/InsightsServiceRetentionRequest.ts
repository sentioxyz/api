 ...
 */
export function instanceOfInsightsServiceRetentionRequest(value: object): boolean {
    return true;
}
...
export function InsightsServiceRetentionRequestToJSON(value?: InsightsServiceRetentionRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
