...
export class AlertsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param id 
     */
    public async deleteAlertRule(id: string, _options?: Configuration): Promise<RequestContext> {
    ...
    public async saveAlertRule(body: AlertServiceSaveAlertRuleRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (body === null || body === undefined) {
            throw new RequiredError("AlertsApi", "saveAlertRule", "body");
        }


        // Path Params
        const localVarPath = '/api/v1/alerts/rule';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "AlertServiceSaveAlertRuleRequest", ""),
            contentType
        );
     ...
     * @param body 
     */
    public async saveAlertRule2(id: string, body: AlertServiceAlertServiceSaveAlertRuleBody, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("AlertsApi", "saveAlertRule2", "id");
        }


        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("AlertsApi", "saveAlertRule2", "body");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(body, "AlertServiceAlertServiceSaveAlertRuleBody", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class AlertsApiResponseProcessor {
     ...
     */
     public async deleteAlertRuleWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to saveAlertRule
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async saveAlertRuleWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to saveAlertRule2
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async saveAlertRule2WithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
