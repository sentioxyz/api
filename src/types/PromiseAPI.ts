...
export class PromiseDebugAndSimulationApi {
     ...
     */
    public getEstimatedGasPriceWithHttpInfo(chainId?: string, _options?: Configuration): Promise<HttpInfo<SolidityServiceGetEstimatedGasPriceResponse>> {
        const result = this.api.getEstimatedGasPriceWithHttpInfo(chainId, _options);
        return result.toPromise();
    }
     ...
     * @param [chainId] Current support chain id: 1
     */
    public getEstimatedGasPrice(chainId?: string, _options?: Configuration): Promise<SolidityServiceGetEstimatedGasPriceResponse> {
        const result = this.api.getEstimatedGasPrice(chainId, _options);
        return result.toPromise();
    }
     ...
     * @param [pageToken]
     */
    public searchTransactions(owner: string, slug: string, chainId?: Array<string>, address?: Array<string>, includeDirect?: boolean, includeTrace?: boolean, includeIn?: boolean, includeOut?: boolean, startBlock?: string, endBlock?: string, startTimestamp?: string, endTimestamp?: string, transactionStatus?: Array<number>, methodSignature?: string, limit?: number, pageToken?: string, _options?: Configuration): Promise<SolidityServiceEvmSearchTransactionsResponse> {
...
export class PromiseProcessorApi {
     ...
     */
    public getProcessorStatusV2WithHttpInfo(owner: string, slug: string, version?: 'ACTIVE' | 'PENDING' | 'ALL', _options?: Configuration): Promise<HttpInfo<ProcessorServiceGetProcessorStatusResponse>> {
        const result = this.api.getProcessorStatusV2WithHttpInfo(owner, slug, version, _options);
        return result.toPromise();
    }
     ...
     * @param [version]  - ACTIVE: Only active version  - PENDING: Only pending versions  - ALL: All version
     */
    public getProcessorStatusV2(owner: string, slug: string, version?: 'ACTIVE' | 'PENDING' | 'ALL', _options?: Configuration): Promise<ProcessorServiceGetProcessorStatusResponse> {
        const result = this.api.getProcessorStatusV2(owner, slug, version, _options);
        return result.toPromise();
    }
